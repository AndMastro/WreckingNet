...
if __name__ == "__main__":
    ...
    batch_size = 8 #16 if on 1060
    epochs = 40 #1000 if on 970
    ...
    opt = tf.train.AdamOptimizer(learning_rate=0.00005) #it helps to go out the local minimum. with 0.0001 and 40 epochs ok. Must remove oscillations.
